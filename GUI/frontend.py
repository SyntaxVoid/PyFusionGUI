...
class PyFusionWindow:
    def __init__(self):
        ...
        self.run_analysis_button = tk.Button(master=self.settings_buttons_frame,
                                             text="Run Analysis",
                                             font=(font_name, 13), width=14,
                                             command=self.run_analysis)
        self.run_analysis_button.grid(row=3, column=0, sticky=tk.N)
        return
